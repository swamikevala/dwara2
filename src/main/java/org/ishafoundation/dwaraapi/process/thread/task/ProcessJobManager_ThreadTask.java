...
//	@Override
//    public void run() {
//		logger.trace("managing process job - " + job.getId());
...
//			logger.info("Now kicking off - " + job.getId() + " " + logicalFile.getAbsolutePath() + " task " + job.getTaskId());
...
//				
//			org.ishafoundation.dwaraapi.db.model.master.workflow.Process processDBEntity = tasktypeCacheUtil.getProcess(processId);
