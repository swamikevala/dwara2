...
//	}
	...
	public org.ishafoundation.dwaraapi.api.resp.ingest.Request frameRequestObjectForResponse(Request request, List<Subrequest> subrequestList){
		...
		for (Subrequest nthSubrequest : subrequestList) {
			org.ishafoundation.dwaraapi.api.resp.ingest.Subrequest subrequestForResponse = frameSubrequestObjectForResponse(nthSubrequest);
...
//	}
	...
	public org.ishafoundation.dwaraapi.api.resp.ingest.Subrequest frameSubrequestObjectForResponse(Subrequest subrequest){
		
		org.ishafoundation.dwaraapi.api.resp.ingest.Subrequest subRequestForResponse = frameSubrequestObjectWithJobDetailsForResponse(subrequest, null);
		
		return subRequestForResponse;		
	}
	
	public org.ishafoundation.dwaraapi.api.resp.ingest.SubrequestWithJobDetails frameSubrequestObjectWithJobDetailsForResponse(Subrequest subrequest,  List<Job> jobList){
