...
import org.ishafoundation.dwaraapi.storage.storagetype.thread.StoragetypeThreadPoolExecutor;
...
public class StoragetypeJobDelegator {
	...
	@Autowired
	private StoragetypeThreadPoolExecutor storagetypeThreadPoolExecutor;
