...
//			}
	...
	protected void afterRestore(SelectedStorageJob selectedStorageJob, StorageResponse storageResponse) throws Exception {
		...
		if(requestedAction == Action.restore || requestedAction == Action.restore_process || requestedAction == Action.rewrite || requestedAction == Action.generate_mezzanine_proxies || requestedAction == Action.restore_tape_and_move_it_to_cp_proxy_server) { // for ingest and restore_process with dependent jobs this happens in the scheduler... 
