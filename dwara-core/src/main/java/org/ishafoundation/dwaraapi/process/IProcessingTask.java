...
public interface IProcessingTask {
	 ...
	 */
	public ProcessingtaskResponse execute(String taskName, String inputArtifactName, org.ishafoundation.dwaraapi.db.model.transactional.domain.File file, Domain domain, LogicalFile logicalFile, String category, String destinationDirPath) throws Exception;
