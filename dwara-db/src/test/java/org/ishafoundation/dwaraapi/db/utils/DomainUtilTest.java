 ...
 * 
 * @SpringBootTest public class DomainUtilTest {
 * 
 * private static final Logger logger =
 * LoggerFactory.getLogger(DomainUtilTest.class);
 * 
 * @Autowired private DomainUtil domainUtil;
 * 
 * @Test public void test_a_NullDomain() { Artifact artifact =
 * domainUtil.getDomainSpecificArtifact(null, 6);
 * logger.debug(artifact.getClass().getName()); }
 * 
 * @Test public void test_b_SpecificDomain() { Artifact artifact =
 * domainUtil.getDomainSpecificArtifact(Domain.TWO, 1);
 * logger.debug(artifact.getClass().getName()); } }
 */