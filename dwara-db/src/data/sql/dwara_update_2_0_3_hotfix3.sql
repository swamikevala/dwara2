...
INSERT INTO artifactclass_task (id, artifactclass_id, storagetask_action_id, processingtask_id, config) VALUES (14, 'video-digi-2020-pub', NULL, 'file-copy', '{\"pathname_regex\": \".*.mkv$\", \"destination_id\" : \"bru\"}');
INSERT INTO artifactclass_task (id, artifactclass_id, storagetask_action_id, processingtask_id, config) VALUES (15, 'video-digi-2020-priv1', NULL, 'file-copy', '{\"pathname_regex\": \".*.mkv$\", \"destination_id\" : \"bru\"}');
INSERT INTO artifactclass_task (id, artifactclass_id, storagetask_action_id, processingtask_id, config) VALUES (16, 'video-digi-2020-priv2', NULL, 'file-copy', '{\"pathname_regex\": \".*.mkv$\", \"destination_id\" : \"bru\"}');
